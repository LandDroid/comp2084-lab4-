namespace PhoneStoreApp.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<PhoneStoreApp.Models.DataContext>
    {
        ...
        protected override void Seed(PhoneStoreApp.Models.DataContext context)
        {
